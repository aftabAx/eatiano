...
import login from '../assests/login.jpeg';
...
const SignIn = () => {
  ...
  const loginHandler = async (e) => {
    ...
    const response = await axios.post(
      'https://achievexsolutions.com/eatiano_backend/public/index.php/api/auth/login',
      {
      ...
      <div className='font-rubik'>
        ...
        <div className='relative py-8 lg:bg-no-repeat lg:bg-center lg:bg-login md:py-12 lg:py-20'>
          ...
          <div className='container relative flex items-center justify-center lg:justify-start'>
            <div className='flex flex-col login-border '>
              <div >
                <form onSubmit={loginHandler}>
                  ...
                  <div className='mb-10 md:mb-14'>
                    ...
                    {!loading && (
                      <button
                        type='submit'
                        className='w-full px-8 py-2 text-lg font-medium  text-gray-900 transition-all duration-300 rounded-lg mb-7 md:mb-12 hover:text bg-cta md:text-xl hover:bg-cta-dark hover:scale-110 focus:ring-2 ring-offset-2 ring-cta-dark login-button'
                      >
                        LOGIN
                      </button>
                    )}
              ...
              <div>
                <div>
                  <button className='social_login w-full px-8 py-2 mb-5 text-gray-100 transition-all duration-300 rounded-lg md:mb-9 hover:text bg-fb-blue md:text-lg hover:bg-fb-blue-dark hover:scale-110 focus:ring-2 ring-offset-2 ring-fb-blue-dark'>
                    <i className='mr-2 fab fa-facebook'></i> Login with
                    Facebook
                  </button>
                </div>

                <div>
                  <button className='social_login w-full px-8 py-2 mb-5 text-gray-100 transition-all duration-300 rounded-lg md:mb-9 hover:text bg-google-red md:text-lg hover:bg-google-red-dark hover:scale-110 focus:ring-2 ring-offset-2 ring-google-red-dark'>
                    <i className='mr-2 fab fa-google'></i> Login with Google
                  </button>
                </div>
                <div>
                  <GoogleOAuthProvider clientId="792985894875-j7jq7pih5rn6lb9e2dfki75bu2n13hou.apps.googleusercontent.com">
                    <GoogleLogin
